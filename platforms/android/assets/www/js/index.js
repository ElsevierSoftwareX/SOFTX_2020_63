...
//var address = "http://ticproject.univ-corse.fr:8080";
...
function parse_dsp(data, dsp){
    ...
    $("#footer").html(
        "<div data-role='fieldcontain'>\
         ...
         <input type='text' name='time' id='time' value='1000' data-inline='true' />\
         </div>\
		<button id='simulate' class='btn btn-primary btn-block'>Simulate</button>\
        <br>\
        <h4>Description</h4>\
        <p>"+description+"</p>"
        );
...
function simulate(dsp_name) {
    ...
    var url = sessionStorage.ip+"simulate?name="+dsp_name+"&time="+$('#time').val();
    ...
    xhr.onload = function() {
        ...
        $("#header").html("<a class='navigate-left' onClick=\"window.location='index.html?view=dsp&dsp="+dsp_name+"'\" data-transition='slide-out'><h3 class='center'>Simulation Results</h3></a>");
